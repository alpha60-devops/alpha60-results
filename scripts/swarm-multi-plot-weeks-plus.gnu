...
set xlabel "WEEKS" font "Apercu,24" offset 0,-10
...
set xtics 1 rotate by 90 right nomirror
set xrange [0:*]

#plot 'r4k-weeks.csv' using 1:2:xticlabels(6)

plot 'r4k-weeks.csv' using 1:2:xticlabels(sprintf('%s  %3u', stringcolumn(6), column(1))) notitle
