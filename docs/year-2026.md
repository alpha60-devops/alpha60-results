...
{::nomarkdown}
{% include open-sample-2026-downloads-by-week-normalized-start.svg %}
{:/}
<div style="height: 50px;"></div>
...
{% include open-sample-2026-meta-collection-table.html %}
<div style="height: 50px;"></div>

{% include open-sample-2026-media-objects-table.html %}
<div style="height: 50px;"></div>
